...
public class UploadListActivity extends FileActivity {
    ...
    private void setupContent() {
        ...
        swipeListRefreshLayout.setOnRefreshListener(() -> {
            setLoadingMessage();
            uploadListAdapter.updateUploads();
            checkLoadingMessage();
        });
    ...
    private void checkLoadingMessage() {
    ...
    private void setLoadingMessage() {
        emptyContentHeadline.setText(R.string.upload_list_loading);
    ...
    private void setListShown(boolean shown) {
        if (recyclerView != null) {
            ...
            emptyTextView.setVisibility(shown && uploadListAdapter.getItemCount() == 0 ? View.VISIBLE : View.GONE);
        }
    }
